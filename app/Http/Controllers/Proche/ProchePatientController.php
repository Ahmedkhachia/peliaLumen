...
namespace App\Http\Controllers\Proche;
...
use App\Mesure;
use App\Proches_Patients;
use Auth;

class ProchePatientController extends BaseController
{
    ...
    public function GetInfoPatient($id){
        $getProches_Patients = Proches_Patients::where([["id_patient", $id], ["id_proche", Auth::user()->id]])->first();
        if(!empty($getProches_Patients)){
    ...
    public function edit($id, $id_patient){
        $getProches_Patients = Proches_Patients::where(["id_patient", $id_patient], ["id_proche", Auth::user()->id])->first();
        if(!empty($getProches_Patients)){
